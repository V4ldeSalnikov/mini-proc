...
def main() -> None:
    ...
    for seed in range(10):
        ...
        objects = create_rule_layout(room, assets, seed=seed)
        ...
        render_rgb(f"outputs/renders/rule_layout_examples/layout_{seed:03d}.png")
        save_blend(f"outputs/scenes/rule_layout_examples/layout_{seed:03d}.blend")
